...
class Wav2Vec2Model(Wav2Vec2Model):
    ...
    def forward(
        ...
        hidden_states = self.feature_extractor(input_values)  # (B,C,L)
        hidden_states = hidden_states.transpose(1, 2)  # (B,L,C)  L=299
        ...
        if dataset == "BIWI":
            ...
            # frame_num = int(hidden_states.shape[-2]*cfg.video_fps/cfg.audio_fps)
